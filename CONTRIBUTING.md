# regislon/administrative_boundaries Contributing Guide

Hi! Thanks for taking the time to contribute to regislon/administrative_boundaries.

_You can contribute in many ways_

- Join the [discussion](https://github.com/regislon/administrative_boundaries/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/regislon/administrative_boundaries/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/regislon/administrative_boundaries/issues/new/choose)
